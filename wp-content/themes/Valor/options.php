...
function optionsframework_options() {
	...
	$options[] = array( "name" => "Настройка логотипа",
						"desc" => "Поставьте галочку если вы хотите использовать изображение логотипа.",
						"id" => "w2f_logo",
						"std" => "1",
						"type" => "checkbox");		
		
	$options[] = array( "name" => "Логотип сайта",
						"desc" => "Загрузить картинку логотипа.",
						"id" => "w2f_logopic",
						"std" => get_bloginfo('template_url') ."/images/logo.png",
						"type" => "upload");	
		
	$options[] = array( "name" => "Количество обзоров на главной",
						"desc" => "Установить количество обзоров для показа на главной.",
						"id" => "w2f_review_number",
						"std" => "5",
						"class" => "mini",
						"type" => "text");

	$options[] = array( "name" => "Количество игр в ТОП на главной",
						"desc" => "Установите количество игр в ТОП на главной",
						"id" => "w2f_top_number",
						"std" => "5",
						"class" => "mini",
						"type" => "text");		
	...
	$options[] = array( "name" => "Выбор категории слайдера",
						"desc" => "Выберите категорию слайдера",
						"id" => "w2f_slide_categories",
						"type" => "select",
						"options" => $options_categories);		
		
	$options[] = array( "name" => "Количество слайдов",
						"desc" => "Установить количество слайдов.",
						"id" => "w2f_slide_number",
						"std" => "4",
						"class" => "mini",
						"type" => "text");		
	...
	$options[] = array( "name" => "Карусель игрового видео",
						"desc" => "Поставьте галочку, если вы хотите, чтобы включить карусель игрового видео.",
						"id" => "w2f_video_slide",
						"std" => "1",
						"type" => "checkbox");	
	
	$options[] = array( "name" => "Количество видео в карусели",
						"desc" => "Установить количество видео в карусели",
						"id" => "w2f_video_number",
						"std" => "5",
						"class" => "mini",
						"type" => "text");	
