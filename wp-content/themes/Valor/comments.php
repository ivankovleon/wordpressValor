...
<?php if ( have_comments() ) : ?>
	<h3 id="comments"><?php comments_number('Нет комментариев', 'Один комментарий', '% Комментарии' );?></h3>
...
<?php else : ?>
<label for="author">Ваше имя <small><?php if ($req) echo "(обязательно)"; ?></small></label>
